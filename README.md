...
`findCliffs()` reports suspicious steps in the adjusted weekly series to the run log but
never patches them, because on a weekly bar a genuine 50% drawdown and a 2:1 split are
indistinguishable.
